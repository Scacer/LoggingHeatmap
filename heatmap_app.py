...
class HeatmapApp(tk.Tk):
    def __init__(self):
        ...
        self.configure(bg="#F0F6FC")  # Light blue background

        self.heatmap = heatmap.Heatmap()

        button_bg = "#2196F3"  # Blue
        button_fg = "white"
        button_hover_bg = "#64B5F6"  # Lighter shade of blue
        ...
        self.visualize_all_button = tk.Button(self.button_frame, text="Visualize All Heatmaps", command=self.visualize_all_heatmaps, bg=button_bg, fg=button_fg, activebackground=button_hover_bg, relief=tk.FLAT, height=2, width=20)
        self.visualize_all_button.grid(row=0, column=3, padx=5, pady=5, sticky="ew")
        ...
        self.visualize_all_button.config(font=button_font)
